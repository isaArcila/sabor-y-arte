...
<body class="index">
        ...
        <div class="menu container">
            <nav class="navbar2">
                <ul style="position:relative; left:130px; ">
                    <li class="li2"><a href="../php/empleado.php">Inicio</a></li>
                    <li class="li2"><a href="../php/productos3.php">Productos</a></li>
        ...
        <div class="header-content">
            ...
            <div class="header-info">
                <div class="header-txt">
                    ...
                    <a href="../php/productos3.php"class="btn-1">Ver más</a>
                </div>
    ...
    <section class="info container">
        ...
        <div class="info-1">
            ...
            <div class="info-2">
           <a href="../php/mapa-empl.php"><img src="../img/ubicacion.png" alt="">
            <h2>Ubicación</h2>
            <p>Sonsón - Ant</p>
        </div>
        </a>
