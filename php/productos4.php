...
<body class="index">
  ...
  <img src="../img/torta red velvet.jpg" class="card-img-top4" alt="Torta">
        ...
        <div class="card-body">
          ...
          <a href="../php/porciones.php" class="btn btn-primary w-100">Ver más</a>
        </div>
      </article>
        ...
        <div class="card-body">
          ...
          <a href="../php/sal.php" class="btn btn-primary3   w-100">Ver más</a>
        </div>
      </article>
        ...
        <div class="card-body">
          ...
          <a href="../php/dulces.php" class="btn btn-primary3   w-100">Ver más</a>
        </div>
      </article>
        ...
        <div class="card-body">
          ...
          <a href="../php/frio.php" class="btn btn-primary3   w-100">Ver más</a>
        </div>
      </article>
       ...
       <article class="card col-sm-6 col-md-4 shadow-sm">
        ...
        <div class="card-body">
          ...
          <a href="../php/caliente.php" class="btn btn-primary3   w-100" style="position:relative; top:13px;">Ver más</a>
        </div>
      </article>
        ...
        <div class="card-body">
          ...
          <a href="../php/panes.php" class="btn btn-primary3   w-100">Ver más</a>
        </div>
      </article>
